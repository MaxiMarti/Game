...
public class Tile {
    ...
    public static final Tile OBJETIVO = new Tile(0xFFFFFF00, new Textura(new Textura("Manzana"), 1, 1, 64));
    public static final Tile ENEMIGO = new Tile(0xFFFF00FF, new Textura(new Textura("Ventana_azul"), 1, 1, 64));
